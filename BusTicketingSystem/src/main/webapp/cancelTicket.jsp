...
%>
	...
	<div class="ticketInfo">
		...
		<table>
			...
			<tr>
				...
				<td><p>
						<%
							out.println(operator + ",\t" + busBrand + ",\t" + busType);
						%>
					</p></td>
			</tr>
			<tr>
	...
	<form action="cancel.jsp" method="get">
		<input type="hidden" name="customer_email"
			value="<%=passenger.getCustomerEmail()%>" /> <input type="hidden"
			name="seat" value="<%=seats%>" /> <input type="hidden" name="tripId"
			value="<%=tripId%>" /> <input type="submit" value="Cancel Ticket"
			style="float: right; height: auto; text-align: center; border-radius: 2px; margin: 30px;" />
